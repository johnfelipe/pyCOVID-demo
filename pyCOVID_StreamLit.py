...
if section == "Project":
    ...
    # TODO: 1. au début de la pandémie, longs délais pour les tests donc les radios = alternative intéressante et AI pouvait aider.
    # TODO: Aujourd'hui tests PCR fonctionnent bien, mais équipes médicales sont en sous effectifs etc
